...
public class QPasswordReset extends EntityPathBase<PasswordReset> {
    ...
    private static final long serialVersionUID = -1377771000L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QPasswordReset passwordReset = new QPasswordReset("passwordReset");

    public final io.eascycm.framework.base.entity.impl.QLogBaseEntityImpl _super = new io.eascycm.framework.base.entity.impl.QLogBaseEntityImpl(this);
